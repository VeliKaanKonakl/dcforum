    ...
    return (
        <div className="p-8">
            <div className="box-content w-42  h-100 sm:w-full mt-3 bg-[#262D34] flex flex-col  rounded-2xl ">
                <div className="flex-row items-center  p-3 flex bg-[#d3dee8]">
                    Meetups
                    <div className=" pl-2 pt-1">
                        <FaArrowRight />
                    </div>
                </div>
                <div className="flex flex-col md:flex-row items-center bg-[#74818e]  w-full h-20 rounded-2xl p-5 mt-10 gap-6">
